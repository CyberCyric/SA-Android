...
function scene:create( event )
    ...
    local txtVolX = display.newText(sceneGroup, "Vol X" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVolX.anchorX = 0
    txtVolX.anchorY = 0
    ...
    local txtVol1 = display.newText(sceneGroup, "Vol 1" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVol1.anchorX = 0
    txtVol1.anchorY = 0
    ...
    local txtVol2 = display.newText(sceneGroup, "Vol 2" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVol2.anchorX = 0
    txtVol2.anchorY = 0
    ...
    local txtVol3 = display.newText(sceneGroup, "Vol 3" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVol3.anchorX = 0
    txtVol3.anchorY = 0
    ...
    local txtVol4 = display.newText(sceneGroup, "Vol 4" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVol4.anchorX = 0
    txtVol4.anchorY = 0
    ...
    local txtVol5 = display.newText(sceneGroup, "Vol 5" , leftSide + 165 ,255, 250, 170,"FjallaOne-Regular.ttf", 16, center )
    txtVol5.anchorX = 0
    txtVol5.anchorY = 0
